...
int main(int argc, const char *argv[])
{
    ...
    float comparison_weights[NUMBER_OF_FEATURES][NUMBER_OF_AGGREGATE_STATS] = {
                { 0.713411, 0.962104, 0.756273, 0.951967},
                { 0.526342, 0.852209, 0.756996, 0.986095},
                { 0.533565, 0.844415, 0.735859, 0.99445},
                { 0.821795, 0.968534, 0.80771, 0.969359},
                { 0.573297, 0.848914, 0.77032, 0.984591},
                { 0.799432, 0.739606, 0.112651, 0.848867},
                { 0.542713, 0.83598, 0.862778, 1},
                { 0, 0.934601, 0.785137, 0.985672}
            };
